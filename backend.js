    ...
    try {
      const emailData = {
        ...
        body: `
          ...
          To confirm your booking, please pay:
          Paybill Number: 247247
          Account Number: 466999
          Business Name: Gonah Nexus
        ...
        if (result.success) {
          ...
          document.getElementById('booking-confirm').innerHTML = `
            ...
            <div style="margin:1.1em 0;">
              ...
              <span style="font-size:1.2em;color:#800000;font-weight:700;">247247</span>
              <p style="margin:0.2rem 0 0;font-size:0.85rem;">Account No: <strong>466999</strong> (Gonah Nexus)</p>
            </div>
