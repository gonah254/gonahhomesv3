...
// Payment Integration for Gonah Homes
class PaymentIntegration {
  constructor() {
    this.paybillNumber = "247247";
    this.accountNumber = "466999";
    this.businessName = "Gonah Nexus";
  }
          ...
          <div style="text-align: center; padding: 2rem;">
            ...
            <div style="background: #f3f4f6; padding: 1.5rem; border-radius: 10px; margin-bottom: 2rem;">
              ...
              <ol style="text-align: left; padding-left: 1rem;">
                <li>Go to mobile money on your phone</li>
                <li>Select "Paybill"</li>
                <li>Enter Business Number: <strong>247247</strong></li>
                <li>Enter Account Number: <strong>466999</strong></li>
                <li>Enter Amount: <strong>KES ${amount}</strong></li>
                <li>Enter your mobile money PIN</li>
                <li>Confirm the payment (recipient: Gonah Nexus)</li>
              </ol>
            </div>

            <div style="background: #fef3c7; padding: 1rem; border-radius: 8px; margin-bottom: 1rem;">
              <p><strong>Note:</strong> You will receive a confirmation SMS. Please save this as proof of payment.</p>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
  window.mpesa = new PaymentIntegration();
});
